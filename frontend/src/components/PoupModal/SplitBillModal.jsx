        ...
        <div className="splitbill-conatiner px-3 py-3">
          ...
          <div className='py-4 d-flex flex-column gap-4' style={{ borderBottom: "1px solid #e3dcdc" }}>
            {payments.map((payment, index) => (
              <div key={payment.id} className='d-flex justify-content-between align-items-center'>
                <label>Payment {index + 1}</label>
                
                <select
                  value={payment.method}
                  onChange={(e) => handleMethodChange(index, e.target.value)}
                  style={{ width: "250px", padding: "5px", borderRadius: "5px", border: "1px solid #e3dcdc" }}
                >
                ...
                <button style={{ border: "none", backgroundColor: "rgb(0, 122, 255)", borderRadius: "5px", color: "white", padding: "5px", width: "100px" }}>
                  Charge
                </button>
                ...
                {payments.length > 1 && (
                  <button
                    ...
                    style={{ marginLeft: '10px', border: "none", backgroundColor: "transparent", color: "red", fontSize: "20px", cursor: "pointer" }}
                  >
                    <RiDeleteBinLine />
                  </button>
                )}
            ...
            <div className='d-flex justify-content-end'>
              <button
                ...
                style={{ border: "none", padding: "5px", borderRadius: "5px", width: "120px", color: "white", backgroundColor: "rgb(0, 122, 255)" }}
              >
                Add More
              </button>
            </div>
          ...
          <div className='d-flex justify-content-end gap-2 py-3'>
            <button style={{ border: "none", padding: "9px", borderRadius: "5px", backgroundColor: "rgb(129, 189, 255)", color: "white" }}>
              Cancel
            </button>
